<template>
  <div class="body">
    ...
    <div class="container">
      ...
      <div class="header">
        ...
        <div class="header-actions">
          <button class="btn btn-primary" @click="goToPage('dashboard')">
            进入监控大屏 (Dashboard)
          </button>
        </div>
      </div>
    ...
    <!-- AI 助手悬浮球 -->
    <div class="ai-fab" @click="$router.push('/aichat')" title="蔡文姬 AI 助手">
