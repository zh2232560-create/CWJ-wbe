    ...
    massage: [
      {
        ...
        store: '奈晚门店',
        price: '¥128',
        image: new URL('@/assets/static/wxj/pillow/yqmm.jpg', import.meta.url).href,
        effect: '改善上气道周围肌肉紧张',
      },
      {
        name: '深度睡眠按摩',
        store: '奈晚门店',
        price: '¥88',
        image: new URL('@/assets/static/wxj/pillow/smtl.jpg', import.meta.url).href,
        effect: '放松神经，提升睡眠质量',
      },
      {
        name: '拔筋点穴',
        store: '奈晚门店',
        price: '¥188',
        image: new URL('@/assets/static/wxj/pillow/dxaj.jpg', import.meta.url).href,
        effect: '缓解头痛，促进血液循环',
      },
    ],
    diet: {
      ...
      products: [
        {
          ...
          brand: '三两小方',
          price: '¥14.9',
          image: new URL('@/assets/static/wxj/pillow/szt.png', import.meta.url).href,
          effect: '理气健脾，消食化积',
        },
        {
          name: '乌梅荷叶饮',
          brand: '三两小方',
          price: '¥25.9',
          image: new URL('@/assets/static/wxj/pillow/hyy.png', import.meta.url).href,
          effect: '清热解暑，利水消肿',
        },
        {
          name: '五黑馒头切片',
          brand: '三两小方',
          price: '¥15.9',
          image: new URL('@/assets/static/wxj/pillow/mtj.png', import.meta.url).href,
          effect: '滋阴补肾，补肝明目',
        },
        {
          name: '低糖轻脂黑芝麻丸',
          brand: '三两小方',
          price: '¥34.9',
          image: new URL('@/assets/static/wxj/pillow/zmw.png', import.meta.url).href,
          effect: '补肝肾，益精血',
        },
      ],
    },
